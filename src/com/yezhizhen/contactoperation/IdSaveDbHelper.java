...
public class IdSaveDbHelper extends SQLiteOpenHelper {
	...
	// 定义一个方法 保存联系人信息
	public void saveContactInfo(ContentResolver contentResolver,
			long rawContactID, ContentValues values, String[] info) {
	...
	// 定义一个方法存储联系人到头像到数据库
	public void updateAvatar(long rawContactID, ContentValues values,
			ContentResolver contentResolver, Bitmap avatarBM) {
